...
from team import Ui_Form
from evaluation import Ui_Dialog
from fetch_team import Ui_Form2
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.l1.setStyleSheet("color: rgb(106, 106, 106);")
...
"color: rgb(98, 98, 98);")
        ...
        self.t2.setGeometry(QtCore.QRect(190, 130, 21, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.t3.setGeometry(QtCore.QRect(530, 130, 21, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
...
"")
        ...
        self.actionNEW_Team.triggered.connect(self.team_name)
        ...
        self.action_OPEN_Team.triggered.connect(self.fetch_team)
        ...
        self.action_EVALUATE_Team.triggered.connect(self.evaluation)
    ...
    def retranslateUi(self, MainWindow):        
        ...
        self.t1.setText(_translate("MainWindow", "Displayed Here"))
