...
class Ui_msg3(object):
    def setupUi(self, Dialog):
        ...
        self.label_2.setGeometry(QtCore.QRect(50, 50, 171, 16))
        font = QtGui.QFont()
        font.setPointSize(9)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Do you want to create new team?"))
        self.label_2.setText(_translate("Dialog", "Select New Team from menu."))
